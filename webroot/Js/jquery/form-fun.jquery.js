...
$(function(){
	...
	$("#choose_registration").val('Please Choose');
	...
	$("#choose_registration").change(function() {

		$(".name_wrap").slideUp().find("input").removeClass("active_name_field");
		
		switch ($("#choose_registration option:selected").text()) {
			case 'Simple info':
	...
	$("#rock").click(function(){
		if (this.checked && $("#choose_registration option:selected").text() != 'Please Choose'
