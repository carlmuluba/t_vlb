...
?>
            <?php
                $publications = $this->requestAction('publications/elpopularPubs1/sort:visitorsip/direction:asc/limit:10'); 
                foreach ($publications as $publication): ?>
                <div id='block_content'>
                <div class='list_img'>
		<?php echo $this->Html->link($this->Html->image('http://localhost:8888/'.$publication['Publisher']['publisher_name'].'/pages/cover.jpg', array('height'=>100, 'class'=>'img')), array('action' => 'publicationsview', $publication['Publication']['id']), array('escape' => false)); ?>
                </div>
<div class='list_txt'>
                <ul>
